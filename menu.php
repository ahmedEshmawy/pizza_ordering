					...
					while ($row = $result1->fetch()) {
						echo <<<"foodCategories"
									<div class="col-md-3 nav-link-wrap mb-5">
										...
										<a class="nav-link active" id="v-pills-1-tab" data-toggle="pill" href="#v-pills-1" role="tab" aria-controls="v-pills-1" aria-selected="true">{$row['title']}</a>																		
										</div>
									</div>
								foodCategories;
					}
								...
								<div class="row">
									...
									<div class="col-md-4 text-center">
										<div class="menu-wrap">
											...
											<div class="text">
												<h3><a href="#">{$row2['title']}</a></h3>
												<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
												<p class="price"><span>{$row2['price']}</span></p>
